...
knitr::include_graphics("script.png", dpi = 270)
```
...
knitr::include_graphics("rstudio-diagnostic.png")
```
...
knitr::include_graphics("rstudio-diagnostic-tip.png")
```
...
knitr::include_graphics("rstudio-diagnostic-warn.png")
```
...
knitr::include_graphics("clean-slate.png", dpi = 270)
```
