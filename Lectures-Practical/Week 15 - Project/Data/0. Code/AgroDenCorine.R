...
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# Agricultural Density based on Corine

## Define the value for Agricultural areas 
NatAreaVal <- c(2) 
...
CorineDK.2012.Agro <- reclassify(x = CorineDK.2012, # raster to reclassify
                                   rcl = ReclassMrtx # the Reclassification matrix
)
### Now lets look at it
plot(CorineDK.2012.Agro)
...
CorineDK.2012.Agro1k <- aggregate(x = CorineDK.2012.Agro, # raster to aggregate
...
CorineDK.2018.Agro <- reclassify(x = CorineDK.2018, # raster to reclassify
                                   rcl = ReclassMrtx # the Reclassification matrix
)
### Now lets look at it
plot(CorineDK.2018.Agro)
...
CorineDK.2018.Agro1k <- aggregate(x = CorineDK.2018.Agro, # raster to aggregate
                                    fact = 10, # Aggregation factor (number of cells in each direction to merge together)
                                    fun = Summ.Func) # how to aggregate the cells
### Now lets look at this reclassified map
plot(CorineDK.2018.Agro1k)

#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
## Average of Open Natural density in 2012 and 2018
CorineDK.Agro1k <- mean(stack(CorineDK.2018.Agro1k,CorineDK.2012.Agro1k))

plot(CorineDK.Agro1k)

## Save the Raster
writeRaster(x = CorineDK.Agro1k, # raster to save
            filename = "/Users/alejandroordonez/Dropbox/Courses_&_Conferences/2022/Courses/Statistical and Geospatial Modeling/Lectures-Practical/Project/Data/Agro Density/AgroDens_Cor.tif", # Name of the raster
            format="GTiff", overwrite=TRUE) # Arguments
