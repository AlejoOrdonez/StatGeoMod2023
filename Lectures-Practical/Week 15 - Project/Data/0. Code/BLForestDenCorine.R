...
## Broad-leaved Density:  Broad-leaved Density is calculated as the proportion 
...
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# Broad-leaved forest Density based on Corine

## Define the value for Broad-leaved forest areas 
NatAreaVal <- c(311) 
...
CorineDK.2012.BL.Forest <- reclassify(x = CorineDK.2012, # raster to reclasify
                                   rcl = ReclassMrtx # the Reclassification matrix
)
### Now lets look at it
plot(CorineDK.2012.BL.Forest)
...
CorineDK.2012.BL.Forest1k <- aggregate(x = CorineDK.2012.BL.Forest, # raster to aggregate
...
plot(CorineDK.2012.BL.Forest1k)
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
## Estimations Based on Corine 2018 
### Reclassify the raster so that it ONLY shows the areas considered FOREST AND SEMI- NATURAL AREAS 
CorineDK.2018.BL.Forest <- reclassify(x = CorineDK.2018, # raster to reclasify
                                   rcl = ReclassMrtx # the Reclassification matrix
)
### Now lets look at it
plot(CorineDK.2018.BL.Forest)
...
CorineDK.2018.BL.Forest1k <- aggregate(x = CorineDK.2018.BL.Forest, # raster to aggregate
                                    fact = 10, # Aggregation factor (number of cells in each direction to merge together)
                                    fun = Summ.Func) # how to aggregate the cells
### Now lets look at this reclasified map
plot(CorineDK.2018.BL.Forest1k)

#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
## Average of Open Natural density in 2012 and 2018
CorineDK.BL.Forest1k <- mean(stack(CorineDK.2018.BL.Forest1k,CorineDK.2012.BL.Forest1k))

plot(CorineDK.BL.Forest1k)

## Save the Raster
writeRaster(x = CorineDK.BL.Forest1k, # raster to save
            filename = "/Users/alejandroordonez/Dropbox/Courses_&_Conferences/2022/Courses/Statistical and Geospatial Modeling/Lectures-Practical/Project/Data/Forest Type Density/BLForestDens_Cor.tif", # Name of the raster
            format="GTiff", overwrite=TRUE) # Arguments
