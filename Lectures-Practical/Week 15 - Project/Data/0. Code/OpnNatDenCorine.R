...
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# Open Nature Density based on Corine
...
CorineDK.2012.OpnNat1k <- aggregate(x = CorineDK.2012.OpnNat, # raster to aggregate
...
plot(CorineDK.2012.OpnNat1k)
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
## Estimations Based on Corine 2018 
### Reclassify the raster so that it ONLY shows the areas considered FOREST AND SEMI- NATURAL AREAS 
CorineDK.2018.OpnNat <- reclassify(x = CorineDK.2018, # raster to reclasify
                                   rcl = ReclassMrtx # the Reclassification matrix
)
### Now lets look at it
plot(CorineDK.2018.OpnNat)
...
CorineDK.2018.OpnNat1k <- aggregate(x = CorineDK.2018.OpnNat, # raster to aggregate
                                    fact = 10, # Aggregation factor (number of cells in each direction to merge together)
                                    fun = Summ.Func) # how to aggregate the cells
### Now lets look at this reclassified map
plot(CorineDK.2018.OpnNat1k)

#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
## Average of Open Natural density in 2012 and 2018
CorineDK.OpnNat1k <- mean(stack(CorineDK.2018.OpnNat1k,CorineDK.2012.OpnNat1k))

plot(CorineDK.OpnNat1k)

## Save the Raster
writeRaster(x = CorineDK.OpnNat1k, # raster to save
            filename = "/Users/alejandroordonez/Dropbox/Courses_&_Conferences/2022/Courses/Statistical and Geospatial Modeling/Lectures-Practical/Project/Data/Open Nature Density/OpnNatDens_Cor.tif", # Name of the raster
            format="GTiff", overwrite=TRUE) # Arguments
