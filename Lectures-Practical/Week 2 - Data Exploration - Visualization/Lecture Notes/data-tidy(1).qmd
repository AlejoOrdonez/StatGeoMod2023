---
title: "Data tidying"
author: "Extrated form R for Data Science (2e) was written by Hadley Wickham, Mine Çetinkaya-Rundel, and Garrett Grolemund."
editor: 
  markdown: 
    wrap: sentence
format:
...
knitr::include_graphics("variables.png", dpi = 270)
```
...
knitr::include_graphics("column-names.png", dpi = 270)
```
...
knitr::include_graphics("cell-values.png", dpi = 270)
```
...
knitr::include_graphics("multiple-names.png", dpi = 270)
```
...
knitr::include_graphics("names-and-values.png", dpi = 270)
```
