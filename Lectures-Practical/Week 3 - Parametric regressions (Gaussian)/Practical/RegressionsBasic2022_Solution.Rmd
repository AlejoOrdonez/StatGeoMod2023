...
The residual variation is just normally distributed because the p-value (0.0596) is larger than 0.05.
</div>
...
While `PrecSea` is the most collinear variable with a tolerance value of 0.33 (VIF = 2.9), based on the normally used tolerance threshold of < 0.1, there is no collinearity.
</div>
...
Of the predictors, `Longitude`, `latitude`, `Slope`, and `Precipitation` seasonality show a significant correlation with Log.S.AllGrp.
</div> 
